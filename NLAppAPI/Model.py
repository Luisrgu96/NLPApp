...
df = pd.read_csv('Data/time_series.csv',  parse_dates=[0], header=None,index_col=0, names=['fecha','unidades'])
...
save_object('Model/scaler_time_series.pkl', scaler)
model.save_weights("Model/pesos.h5")
 
# # cargamos cuando haga falta
# loaded_scaler = load_object('Model/scaler_time_series.pkl')
# loaded_model = crear_modeloEmbeddings()
# loaded_model.load_weights("Model/pesos.h5")
